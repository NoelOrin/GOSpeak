...
const svgGroup: Record<string, JSX.Element> = {
	home: (
		<path
	...
	profile: (
		<>
			...
			/>
			<path
				d="M10 40C10 33.3726 16.268 28 24 28C31.732 28 38 33.3726 38 40"
				fill="none"
				stroke="currentColor"
				stroke-width="4"
	...
	logout: (
		<>
			<path
				d="M20 8H12C10.8954 8 10 8.89543 10 10V38C10 39.1046 10.8954 40 12 40H20"
				fill="none"
				stroke="currentColor"
				stroke-width="4"
				stroke-linecap="round"
